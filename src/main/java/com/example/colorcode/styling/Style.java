...
public class Style {
     ...
     * </p>Value: The name of the scope the style defines.
     */
    public final void setScopeName(String value) {
        auto_ScopeName = value;
    }
