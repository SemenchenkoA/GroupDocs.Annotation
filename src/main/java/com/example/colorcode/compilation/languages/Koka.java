...
{
    public final String getId() { return LanguageId.Koka; }

    public final String getName() { return "Koka"; }

    public final String getCssClassName() { return "koka"; }
    ...
    public final IGenericList<LanguageRule> getRules()
    {
        ...
        tmp0.addItem(            
            ...
            // operator keywords
            new LanguageRule(
                StringExtensions.concat("(?<!",  symbol,  ")(",  opkeywords,  ")(?!",  symbol,  ")"),tmp2
        ...
        tmp0.addItem(
            ...
            // module and imports
            new LanguageRule(
                "\\b(module)\\s+(interface\\s+)?((?:[a-z]\\w*/)*[a-z]\\w*)",tmp2
        ...
        tmp0.addItem(new LanguageRule(
                "\\b(import)\\s+((?:[a-z]\\w*/)*[a-z]\\w*)\\s*(?:(=)\\s*(qualified\\s+)?((?:[a-z]\\w*/)*[a-z]\\w*))?",tmp2
        ...
        tmp0.addItem(
            ...
            // keywords
            new LanguageRule(
                StringExtensions.concat("\\b(",  plainKeywords,  "|",  typeKeywords,  ")\\b"),tmp2
                  
                    
                           
                    ));
        tmp0.addItem(new LanguageRule(
                StringExtensions.concat("\\b(",  controlKeywords,  ")\\b"),tmp2
                  
                    
                           
                    ));
        tmp0.addItem(new LanguageRule(
                StringExtensions.concat("\\b(",  pseudoKeywords,  ")\\b"),tmp2
        ...
        tmp0.addItem(
            ...
            // Names
            new LanguageRule(
                StringExtensions.concat("([a-z]\\w*/)*([a-z]\\w*|\\(",  symbols,  "\\))"),tmp2
        ...
        tmp0.addItem(
            ...
            // Literals
            new LanguageRule(
                "0[xX][\\da-fA-F]+|\\d+(\\.\\d+([eE][\\-+]?\\d+)?)?",tmp2
                  
                    
                           
                    ));
        tmp0.addItem(new LanguageRule(
                StringExtensions.concat("(?s)'(?:[^\\t\\n\\\\']+|(",  escape,  ")|\\\\)*'"),tmp2
        ...
        tmp0.addItem(new LanguageRule(
                        "^\\s*(\\#error|\\#line|\\#pragma|\\#warning|\\#!/usr/bin/env\\s+koka|\\#).*?$",tmp2));
        return tmp0;
    }
