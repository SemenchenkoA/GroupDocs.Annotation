...
{
    public final String getId() { return LanguageId.Fortran; }

    public final String getName() { return "Fortran"; }

    public final String getCssClassName() { return "fortran"; }
    ...
    public final IGenericList<LanguageRule> getRules()
    {
        ...
        tmp0.addItem(
                        // Module keywords
                        new LanguageRule(
                           "(?i)\\b(?:module|endmodule|contains)\\b",tmp1
        ...
        tmp0.addItem(
                        // Type keywords
                        new LanguageRule(
                           "(?i)\\b(?:type|endtype|abstract)\\b",tmp1
        ...
        tmp0.addItem(
                        ...
                        new LanguageRule(
                           "(?i)\\b(?:interface|endinterface|operator|assignment)\\b",tmp1
        ...
        tmp0.addItem(
                        ...
                        new LanguageRule(
                           "(?i)\\b(?:function|endfunction|subroutine|endsubroutine|elemental|recursive|pure)\\b",tmp1
        ...
        tmp0.addItem(
                       // Variable keywords
                        new LanguageRule(
                           "(?i)INTEGER|REAL|DOUBLE\\s*PRECISION|COMPLEX|CHARACTER|LOGICAL|TYPE",tmp1
        ...
        tmp0.addItem(
                        // Attribute keywords
                        new LanguageRule(
                           "(?i)\\b(?:parameter|allocatable|optional|pointer|save|dimension|target)\\b",tmp1
        ...
        tmp0.addItem(
                        // Intent keywords
                        new LanguageRule(
                           "(?i)\\b(intent)\\s*(\\()\\s*(in|out|inout)\\s*(\\))",tmp1
        ...
        tmp0.addItem(
                        // Intrinsic functions
                        new LanguageRule(
                           StringExtensions.concat("(?i)(call)\\s+(", 
        ...
        tmp0.addItem(
                        ...
                        new LanguageRule(
                           "(?i)(?:#define|#elif|#elifdef|#elifndef|#else|#endif|#error|#if|#ifdef|#ifndef|#include|#line|#pragma|#undef)\\b",tmp2
        ...
        tmp0.addItem(
                        // General keywords
                        new LanguageRule(
                           StringExtensions.concat("(?i)\\b(?:end|use|do|enddo|select|endselect|case|endcase|if|then|else|endif|implicit|none",  "|do\\s+while|call|public|private|protected|where|go\\s*to|file|block|data|blockdata",  "|end\\s*blockdata|default|procedure|include|go\\s*to|allocate|deallocate|open|close|write|stop|return)\\b"),tmp1));
        return tmp0;
    }
