...
{
    public final String getId() { return LanguageId.VbDotNet; }

    public final String getName() { return "VB.NET"; }

    public final String getCssClassName() { return "vb-net"; }
    ...
    public final IGenericList<LanguageRule> getRules()
    {
        ...
        tmp0.addItem(new LanguageRule(
                           "(?:\\s|^)(\\#End\\sRegion|\\#Region|\\#Const|\\#End\\sExternalSource|\\#ExternalSource|\\#If|\\#Else|\\#End\\sIf)(?:\\s|\\(|\\r?$)",tmp2
