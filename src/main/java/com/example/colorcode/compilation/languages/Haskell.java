...
{
    public final String getId() { return LanguageId.Haskell; }

    public final String getName() { return "Haskell"; }

    public final String getCssClassName() { return "haskell"; }
    ...
    public final IGenericList<LanguageRule> getRules()
    {
        ...
        tmp0.addItem(
            ...
            // Special sequences
            new LanguageRule(
                StringExtensions.concat("\\b(module)\\s+(",  qconid,  ")(?:\\s*\\(",  inexports,  "\\))?"),tmp2
        ...
        tmp0.addItem(new LanguageRule(
                StringExtensions.concat("\\b(import)\\s+(qualified\\s+)?(",  qconid,  ")\\s*",  "(?:\\(",  inexports,  "\\))?",  "(?:(hiding)(?:\\s*\\(",  inexports,  "\\)))?"),tmp2
        ...
        tmp0.addItem(
            ...
            // Keywords
            new LanguageRule(
                StringExtensions.concat("\\b(",  keywords,  ")\\b"),tmp2
