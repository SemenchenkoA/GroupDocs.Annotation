...
{
    public final String getId() { return LanguageId.Markdown; }

    public final String getName() { return "Markdown"; }

    public final String getCssClassName() { return "markdown"; }
    ...
    public final IGenericList<LanguageRule> getRules()
    {
        ...
        tmp0.addItem(
                       ...
                       // link
                       new LanguageRule(
                           StringExtensions.concat(link(link()),  "|",  link()),tmp1  // support nested links (mostly for images)
