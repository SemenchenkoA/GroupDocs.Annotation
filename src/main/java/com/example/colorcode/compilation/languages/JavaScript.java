...
{
    public final String getId() { return LanguageId.JavaScript; }

    public final String getName() { return "JavaScript"; }

    public final String getCssClassName() { return "javascript"; }
