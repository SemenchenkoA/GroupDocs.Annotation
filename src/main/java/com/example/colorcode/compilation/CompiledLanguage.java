...
public class CompiledLanguage {
    ...
    public final IGenericList<String> getCaptures() {
        return auto_Captures;
    }

    public final void setCaptures(IGenericList<String> value) {
        auto_Captures = value;
    }
    ...
    public final java.util.regex.Pattern getRegex() {
        return Regex.toJava(getRegexInternal());
    }

    //JAVA: property accessor is internalized
    public Regex getRegexInternal() {
        return auto_Regex;
    }

    //JAVA-added public wrapper for internalized property accessor
    public final void setRegex(java.util.regex.Pattern value) {
        setRegexInternal(Regex.fromJava(value));
    }

    //JAVA: property accessor is internalized
    void setRegexInternal(Regex value) {
        auto_Regex = value;
    }
