...
public class Scope {
    ...
    public final IGenericList<Scope> getChildren() {
        return auto_Children;
    }

    public final void setChildren(IGenericList<Scope> value) {
        auto_Children = value;
    }
    ...
    public final void setParent(Scope value) {
        auto_Parent = value;
    }
